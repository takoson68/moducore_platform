...
## 來源：`ai_new/world/IMPLICIT_WORLD_ASSUMPTIONS.txt`
...
- `ai_new/projects/` 與 `ai_new/projects/modules/` 的存在性為工程推論，需世界或工程正式定義。
- `ai_new/outputs/`、`ai_new/prompts/`、`ai_new/tools/` 的存在性為工程推論，需世界或工程正式定義。
